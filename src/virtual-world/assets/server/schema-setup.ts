...
export function ensureLateWorldDatabaseSchema(collector?: Array<any>): void {
  ...
  [
    ...
    ["addIntegerColumn", "home_row", true],
    ["addIntegerColumn", "home_col", true],
  ].forEach(function (entry) {
    runWorldSchemaStep(
      String(entry[0]),
      VWORLD_NPC_TABLE,
...
function runWorldDatabaseMigration(): void {
  ...
  [
    ...
    ["addTextColumn", "progression_json", true],
    ["addTextColumn", "messages_json", true],
  ...
  [
    ...
    ["addTextColumn", "death_class_id", true],
    ["addTextColumn", "corpse_item_id", true],
  ...
  [
    ...
    ["addTextColumn", "generation_json", true],
